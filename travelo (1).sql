...
--
-- Host: localhost
-- Generation Time: May 29, 2023 at 02:45 PM
...
INSERT INTO `bookings` (`id`, `user`, `fullname`, `phone`, `trip`, `bus`, `seat`, `luggage`, `price`, `location`, `payed`, `due`, `created`) VALUES
(1, 2, 'user full name', '111', 2, 3, 1, 0, 11000, 1, 0, '2023-05-21 00:00:00', '0000-00-00 00:00:00'),
(2, 2, 'user full name', '111', 2, 3, 2, 0, 11000, 1, 0, '2023-05-21 00:00:00', '0000-00-00 00:00:00'),
(3, 2, 'user full name', '111', 1, 1, 1, 0, 14000, 1, 1, '2023-05-18 00:00:00', '0000-00-00 00:00:00'),
(12, 2, 'user full name', '111', 6, 5, 1, 0, 24000, 1, 1, '2023-05-31 00:00:00', '2023-05-29 15:47:03'),
(13, 2, 'user full name', '111', 6, 5, 2, 1, 24000, 1, 1, '2023-05-31 00:00:00', '2023-05-29 15:47:03'),
(14, 1, 'administrator', '222', 6, 5, 1, 1, 24000, 1, 0, '2023-05-31 00:00:00', '2023-05-29 16:15:12'),
(15, 1, 'administrator', '222', 6, 5, 2, 1, 24000, 1, 0, '2023-05-31 00:00:00', '2023-05-29 16:15:12'),
(16, 1, 'administrator', '222', 6, 6, 1, 1, 24000, 1, 0, '2023-05-31 00:00:00', '2023-05-29 17:10:45');
...
CREATE TABLE `bus` (
  ...
  `status` int(1) NOT NULL COMMENT 'حالة الباص متوفر أم لا',
...
(5, 'بخنان 4', '1567', 24, 24000, 6, 6, '2023-05-31 00:00:00', 1, '2023-06-01T15:21'),
(6, 'بخنان 5', '1567', 24, 24000, 6, 6, '2023-05-31 00:00:00', 1, '2023-06-01T15:21');
...
(2, 2, 2, 0, '2023-05-05 00:00:00'),
(3, 3, 2, 0, '2023-05-05 00:00:00'),
(4, 2, 3, 0, '2023-05-05 00:00:00'),
(5, 3, 4, 0, '2023-05-05 00:00:00'),
(6, 6, 1, 0, '0000-00-00 00:00:00'),
(7, 6, 2, 0, '0000-00-00 00:00:00'),
(8, 5, 1, 0, '0000-00-00 00:00:00'),
(9, 5, 2, 0, '0000-00-00 00:00:00');
...
(1, 3, 2, '\'day\'', '2023-05-27 09:21:48', 1),
(2, 3, 3, '\'day\'', '2023-05-27 09:21:48', 1),
(6, 1, 3, '\'day\'', '2023-05-31 15:14:00', 1);
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','client') NOT NULL COMMENT 'نوع الحساب - مدير نظام أو زبون',
...
(1, 'admin', 'administrator', '222', '222', '132', 1, 'admin', '2023-04-23 21:13:04'),
(2, 'user', 'user full name', '123', '111', '123', 1, 'client', '2023-04-23 21:13:04'),
(14, 'عوض الله', 'عوض', 'cc45133cc31f904237ff', '555', '555', 1, 'client', '2023-05-29 16:40:37');
...
--
ALTER TABLE `bookings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'معرف أو المفتاح الرئيسي', AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `cities`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'معرف أو المفتاح الرئيسي', AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'معرف أو المفتاح الرئيسي', AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `bookings`
  ADD CONSTRAINT `bookings_ibfk_1` FOREIGN KEY (`location`) REFERENCES `cities` (`id`),
  ...
  ADD CONSTRAINT `bookings_ibfk_5` FOREIGN KEY (`user`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
